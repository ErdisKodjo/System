 ...
 * (target_link_libraries afros-power-management PUBLIC afros-hal). En cas de
 * build partiel sans la cible, le CMakeLists de afros-power-management repli
 * sur ${CMAKE_SOURCE_DIR}/afros-core/Kernel/hal/include comme include direct.
 */
